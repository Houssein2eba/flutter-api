...
class RouteClass{
  ...
  static List<GetPage> getPages() {
    return [
      GetPage(name: dashBoard, page: () => DashboardScreen(),middlewares: [SanctumAuthMiddleware()],binding: UserBinding()),
      GetPage(name: home, page: () => HomePage(),middlewares: [SanctumAuthMiddleware()],bindings:[AuthBinding(),UserBinding()] ),
      ...
      GetPage(name: notifications, page: () => NotificationPage(),middlewares: [SanctumAuthMiddleware()],bindings: [UserBinding()] ),
