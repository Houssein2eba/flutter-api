...
class EditDeleteButtons extends GetView<Clientscontroller> {
  final Client client;
  const EditDeleteButtons({super.key,required this.client});
          ...
          children: [
            ...
            Material(
              ...
              child: InkWell(
                ...
                onTap: () => controller.goToEditClient(client: client),
                child: Container(
            ...
            Material(
              ...
              child: InkWell(
                borderRadius: BorderRadius.circular(12),
                onTap: () => _showModernDeleteDialog(client.id, client.name),
                child: Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
  ...
  void _showModernDeleteDialog(String clientId, String clientName) {
    Get.dialog(
      Dialog(
